...
contract MixinBancor {
    ...
    IERC20 public constant BANCOR_ETH_ADDRESS = IERC20(0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE);
    ...
    function _tradeBancor(IERC20 buyToken, uint256 sellAmount, bytes memory bridgeData)
        internal
        returns (uint256 boughtAmount)
    {
        ...
        if (path[0] == BANCOR_ETH_ADDRESS) {
            ...
            LibERC20Token.approveIfBelow(path[0], address(bancorNetworkAddress), sellAmount);
        }
