...
contract MixinKyberDmm {
    ...
    function _tradeKyberDmm(IERC20 buyToken, uint256 sellAmount, bytes memory bridgeData)
        internal
        returns (uint256 boughtAmount)
    {
        ...
        require(
            path[path.length - 1] == address(buyToken), "MixinKyberDmm/LAST_ELEMENT_OF_PATH_MUST_MATCH_OUTPUT_TOKEN"
        );
