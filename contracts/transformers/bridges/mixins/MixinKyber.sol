...
contract MixinKyber {
    ...
    IERC20 private immutable KYBER_ETH_ADDRESS = IERC20(0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE);
    ...
    function _tradeKyber(IERC20 sellToken, IERC20 buyToken, uint256 sellAmount, bytes memory bridgeData)
        internal
        returns (uint256 boughtAmount)
    {
        (IKyberNetworkProxy kyber, bytes memory hint) = abi.decode(bridgeData, (IKyberNetworkProxy, bytes));
