...
interface IBridgeAdapter {
    ...
    event BridgeFill(
        bytes32 source, IERC20 inputToken, IERC20 outputToken, uint256 inputTokenAmount, uint256 outputTokenAmount
    );

    function trade(BridgeOrder calldata order, IERC20 sellToken, IERC20 buyToken, uint256 sellAmount)
        external
